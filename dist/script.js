...
function () {
  ...
  _createClass(Difference, [{
    key: "addAnimation",
    value: function addAnimation(items) {
    ...
    value: function init() {
      try {
        this.addAnimation(this.oldItems);
        this.addAnimation(this.newItems);
...
function (_Slider) {
  ...
  function MainSlider(btn) {
    _classCallCheck(this, MainSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, btn));
  }
  ...
  _createClass(MainSlider, [{
    ...
    value: function bindTriggers() {
      ...
      }); // this.nextModulesBtns.forEach(item => { 
